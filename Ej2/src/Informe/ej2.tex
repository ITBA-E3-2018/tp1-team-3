...
\begin{document}
	...
	\cdot (d+\overline{c}+\overline{b}+\overline{a})\cdot (\overline{d}+c+b+a)\cdot
	 ...
	 f =$ (d+c+b)\cdot (d+\overline{c}+\overline{a})\cdot (\overline{d}+c+a)\cdot (\overline{d}+\overline{c}+\overline{a})
	\par
	Luego, aplicando los siguientes cambios de variable y la propiedad 17.a del libro:
	    ...
	    \right.
 		\end{equation}
 	f =$ (d + y\cdot z)\cdot (\overline{d} + y^'\cdot z^')$
	...
	\overline{d}\cdot \overline{c} \cdot b$
	\par
