...
\let\oldinput=\input 	
\def\input#1{\oldinput{../../EJ_1/src/#1}}	
%agrego el archivo y despues restauro al comando original
\subfile{ej1.tex}
\let\input=\oldinput

\let\oldinput=\input 	
\def\input#1{\oldinput{../../EJ_2/src/#1}}	
\subfile{ej2.tex}
\let\input=\oldinput

\let\oldinput=\input 	
\def\input#1{\oldinput{../../EJ_3/src/#1}}	
\subfile{ej3.tex}
\let\input=\oldinput

\let\oldinput=\input 	
\def\input#1{\oldinput{../../EJ_4/src/#1}}	
\subfile{ej4.tex}
\let\input=\oldinput

\let\oldinput=\input 	
\def\input#1{\oldinput{../../EJ_5/src/#1}}	
\subfile{ej5.tex}
\let\input=\oldinput

\let\oldinput=\input 	
\def\input#1{\oldinput{../../EJ_6/src/#1}}	
\subfile{ej6.tex}
\let\input=\oldinput
